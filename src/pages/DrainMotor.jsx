...
export default function DrainMotor() {
  const [images, setImages] = useState([]);
  const [loading, setLoading] = useState(true);
  const [failedImages, setFailedImages] = useState(new Set());

  useEffect(() => {
    // This array contains all the image filenames from the Drain Motor folder
    const imageFiles = [
      'Drain motor black suitable for Samsung.jpeg',
      'Drain motor suitable for GOD.jpeg',
      'Drain motor suitable for IFB.jpeg',
      'Drain motor suitable for LG.jpeg',
      'Drain motor suitable for vcon.jpeg',
      'Drain motor suitable for w:pool.jpeg',
      'Drain motor white suitable for Samsung.jpeg',
    ];

    // Create an array of image objects with paths and formatted names
    const basePath = '/GBPICS/Washing Machine spare pic/Drain Motor';
    ...
    <div className="animate-fade-in">
          ...
          <ol className="flex items-center space-x-2">
            ...
            <li>
              <div className="flex items-center">
                ...
                <span className="ml-2 text-neutral-600 font-medium">Drain Motor</span>
              </div>
            </li>
          </ol>
        </nav>
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 mb-16">
        <div className="border-b border-neutral-200 pb-5 mb-8">
          ...
          <p className="mt-2 text-neutral-600">Browse our extensive range of Drain Motor parts</p>
        </div>
      ...
      <div className="bg-brand-50 py-16 mb-16">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-12">
            <h2 className="text-3xl font-bold text-neutral-800 font-display sm:text-4xl">Why Choose Our Drain Motors</h2>
            <p className="mt-4 text-lg text-neutral-600 max-w-3xl mx-auto">
              Our drain motors are designed for durability, efficiency, and reliable performance
            </p>
          </div>
        ...
        <div className="lg:grid lg:grid-cols-2 lg:gap-16 items-center">
          <div>
            ...
            <div className="mt-6 text-lg text-neutral-600 space-y-4">
              <p>
                Our team of experts is ready to help you find the perfect Drain Motor for your washing machine.
