...
export default function Fuse() {
  ...
  useEffect(() => {
    // No images available for fuse at the moment
    const imageFiles = [];
    ...
    const formattedImages = imageFiles.map(filename => {
      ...
      return {
        path: `/GBPICS/Microwave spare pic/Fuse/${filename}`,
        name: name,
    ...
    <div className="animate-fade-in">
          ...
          <ol className="flex items-center space-x-2">
            ...
            <li>
              <div className="flex items-center">
                ...
                <span className="ml-2 text-neutral-600 font-medium">Fuse</span>
              </div>
            </li>
          </ol>
        </nav>
      ...
      <div className="relative overflow-hidden bg-brand-900 mb-16">
        ...
        <div className="relative max-w-7xl mx-auto py-16 px-4 sm:py-24 sm:px-6 lg:px-8">
          ...
          <p className="mt-6 max-w-xl mx-auto text-xl text-brand-100 sm:max-w-3xl text-center">
            High-quality Fuses for microwave ovens
          </p>
        </div>
      </div>
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 mb-16">
        <div className="border-b border-neutral-200 pb-5 mb-8">
          ...
          <p className="mt-2 text-neutral-600">Browse our extensive range of Fuse parts</p>
        </div>
        ...
        {images.length === 0 ? (
          <div className="text-center py-16">
            ...
            <p className="text-lg text-neutral-600 max-w-2xl mx-auto">
              We're currently updating our fuse inventory. Please contact us directly for fuse parts availability and pricing.
            </p>
            <div className="mt-8">
      ...
      <div className="bg-brand-50 py-16 mb-16">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-12">
            <h2 className="text-3xl font-bold text-neutral-800 font-display sm:text-4xl">Why Choose Our Fuses</h2>
            <p className="mt-4 text-lg text-neutral-600 max-w-3xl mx-auto">
              Our fuses are designed for durability, efficiency, and reliable performance
            </p>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            <div className="bg-white p-6 rounded-xl shadow-card">
              ...
              <h3 className="text-xl font-semibold text-neutral-800 mb-2">Safety Protection</h3>
              <p className="text-neutral-600">
                Our fuses provide essential safety protection for your microwave oven.
              </p>
            </div>
            ...
            <div className="bg-white p-6 rounded-xl shadow-card">
              ...
              <h3 className="text-xl font-semibold text-neutral-800 mb-2">Fast Acting</h3>
              <p className="text-neutral-600">
                Quick response time to protect your appliance from electrical faults.
              </p>
            </div>
            ...
            <div className="bg-white p-6 rounded-xl shadow-card">
              ...
              <h3 className="text-xl font-semibold text-neutral-800 mb-2">Easy Replacement</h3>
              <p className="text-neutral-600">
                Designed for simple installation and replacement when needed.
              </p>
            </div>
          </div>
        </div>
        ...
        <div className="lg:grid lg:grid-cols-2 lg:gap-16 items-center">
          <div>
            ...
            <div className="mt-6 text-lg text-neutral-600 space-y-4">
              <p>
                Our team of experts is ready to help you find the perfect Fuse for your microwave oven.
