...
export default function GearBoxXindi() {
  const [images, setImages] = useState([]);
  const [loading, setLoading] = useState(true);

  useEffect(() => {
    // This array contains all the image filenames from the Gearbox-Xinde folder
    const imageFiles = [
      'Gear box 01 xinde.jpeg',
      'Gear box 02 xinde.jpeg',
      'Gear box 07 xinde.jpeg',
      'Gear box 08 xinde.jpeg',
      'Gear box 11 xinde.jpeg',
      'Gear box 13 xinde.jpeg',
      'Gear box 16 xinde.jpeg',
      'Gear box 17 xinde.jpeg',
      'Gear box 18 xinde.jpeg',
      'Gear box 21 xinde.jpeg',
      'Gear box 21SQ xinde.jpeg',
      'Gear box 22 xinde.jpeg',
      'Gear box 22N xinde.jpeg',
      'Gear box 23 xinde.jpeg',
      'Gear box 25 xinde.jpeg',
      'Gear box 26 (6800) xinde.jpeg',
      'Gear box 32 xinde.jpeg',
      'Gear box 33 xinde.jpeg',
      'Gear box 34 xinde.jpeg',
      'Gear box 35 xinde.jpeg',
      'Gear box 41 xinde.jpeg',
      'Gear box 43 xinde.jpeg',
      'Gear box 49 xinde.jpeg',
      'Gear box 50 xinde.jpeg',
      'Gear box 51 xinde.jpeg',
      'Gear box 56 xinde.jpeg',
      'Gear box 59 xinde.jpeg',
      'Gear box 60 xinde.jpeg',
      'Gear box 61 xinde.jpeg',
    ];
    ...
    const formattedImages = imageFiles.map(filename => {
      ...
      return {
        path: `/GBPICS/Washing Machine spare pic/Gear Box/Gearbox-Xinde/${filename}`,
        name: name,
    ...
    <div className="animate-fade-in">
          ...
          <ol className="flex items-center space-x-2">
            ...
            <li>
              <div className="flex items-center">
                ...
                <span className="ml-2 text-neutral-600 font-medium">Gear Box Xindi</span>
              </div>
            </li>
          </ol>
        </nav>
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 mb-16">
        <div className="border-b border-neutral-200 pb-5 mb-8">
          ...
          <p className="mt-2 text-neutral-600">Browse our extensive range of Gear Box Xindi parts</p>
        </div>
      ...
      <div className="bg-brand-50 py-16 mb-16">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-12">
            <h2 className="text-3xl font-bold text-neutral-800 font-display sm:text-4xl">Why Choose Our Gear Box Xindi</h2>
            <p className="mt-4 text-lg text-neutral-600 max-w-3xl mx-auto">
              Our gear boxes are designed for durability, efficiency, and reliable performance
            </p>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            <div className="bg-white p-6 rounded-xl shadow-card">
              ...
              <p className="text-neutral-600">
                Our gear boxes are engineered with precision for smooth and efficient operation.
              </p>
            </div>
        ...
        <div className="lg:grid lg:grid-cols-2 lg:gap-16 items-center">
          <div>
            ...
            <div className="mt-6 text-lg text-neutral-600 space-y-4">
              <p>
                Our team of experts is ready to help you find the perfect Gear Box Xindi for your washing machine.
