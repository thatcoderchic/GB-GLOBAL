...
export default function Magnetron() {
  ...
  useEffect(() => {
    // This array contains all the image filenames from the Magnetron folder
    const imageFiles = [
      'Magnetron 210 witol.jpeg',
      'Magnetron 213 witol.jpeg',
      'Magnetron 214.jpeg',
      'Magnetron 240 gp.jpeg',
      'Magnetron 610 witol.jpeg',
      'Magnetron 610240 GP witol.jpeg',
      'Magnetron Suitable for w:pool.jpeg',
    ];

    // Create an array of image objects with paths and formatted names
    const basePath = '/GBPICS/Microwave spare pic/Magnetron';
    ...
    <div className="animate-fade-in">
          ...
          <ol className="flex items-center space-x-2">
            ...
            <li>
              <div className="flex items-center">
                ...
                <span className="ml-2 text-neutral-600 font-medium">Magnetron</span>
              </div>
            </li>
          </ol>
        </nav>
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 mb-16">
        <div className="border-b border-neutral-200 pb-5 mb-8">
          ...
          <p className="mt-2 text-neutral-600">Browse our extensive range of Magnetron parts</p>
        </div>
      ...
      <div className="bg-brand-50 py-16 mb-16">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-12">
            <h2 className="text-3xl font-bold text-neutral-800 font-display sm:text-4xl">Why Choose Our Magnetrons</h2>
            <p className="mt-4 text-lg text-neutral-600 max-w-3xl mx-auto">
              Our magnetrons are designed for durability, efficiency, and reliable performance
            </p>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            <div className="bg-white p-6 rounded-xl shadow-card">
              ...
              <h3 className="text-xl font-semibold text-neutral-800 mb-2">High Power Output</h3>
              <p className="text-neutral-600">
                Our magnetrons deliver consistent high power output for efficient microwave cooking.
              </p>
            </div>
        ...
        <div className="lg:grid lg:grid-cols-2 lg:gap-16 items-center">
          <div>
            ...
            <div className="mt-6 text-lg text-neutral-600 space-y-4">
              <p>
                Our team of experts is ready to help you find the perfect Magnetron for your microwave oven.
